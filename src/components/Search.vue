    ...
    <div class="search_panel_container">
        ...
        <div class="second_row_container">
            ...
            <div class="second_col_in_second_row">
                <md-field>
                    ...
                    <md-input @keydown="cheInputValue" type="number" v-model="searchPhone" maxlength="6" ref="num"></md-input>    
        ...
        <div class="third_row_container">
            <ul class="search_result_list">
                <li class="no_result_item" v-show="!searchResults.length && (!isPhoneFieldTouched || !isNameFieldTouched)"> {{noResText}} </li>
...
export default {
    ...
    methods: {
        ...
        cheInputValue(){
            if(this.searchPhone.toString().length >= 6 && event.which != 8 && event.which != 37 && event.which != 38 && event.which != 39 && event.which != 40 ){
...
.search_result_list> li:not(:first-child), .search_result_list> li:not(:nth-child(2)){
    margin-bottom: 10px;
